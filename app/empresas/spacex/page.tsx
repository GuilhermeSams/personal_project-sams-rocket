    ...
    <main className={sharetechmono.className}>
      ...
      <section className="h-full bg-gradient-to-t from-white via-black to-[#010511]">
        ...
        <div className="mt-12">
          ...
          <div className=" max-[455px]:bg-black">
            <div className="ml-28 py-4 max-[744px]:ml-0 max-[455px]:py-0">
              <CardRocketsRight
                nameRocket="Falcon 9"
                src={falcon9}
                alt="Falcon 9"
            ...
            <div className="min-[455px]:hidden">
              <div className="mx-8 border-[1px] border-white"></div>
            </div>
            <div className="mr-28 py-4 max-[744px]:mr-0 max-[455px]:py-0">
              <CardRocketsLeft
